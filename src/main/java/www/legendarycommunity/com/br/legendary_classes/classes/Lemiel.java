...
public class Lemiel implements Listener {
    ...
    public void applyPowers(Player player) {
        ...
        skillsUser.addStatModifier(new StatModifier("Lemiel_System_WISDOM", Stats.WISDOM, 100000.0));
        skillsUser.addStatModifier(new StatModifier("Lemiel_System_HEALTH", Stats.HEALTH, 100000.0));
        skillsUser.addStatModifier(new StatModifier("Lemiel_System_STRENGTH", Stats.STRENGTH, 100000.0));
        skillsUser.addStatModifier(new StatModifier("Lemiel_System_TOUGHNESS", Stats.TOUGHNESS, 100000.0));
            ...
            if (IsLemiel(player)) {
                ...
                if (itemInHand != null && itemInHand.getType() == Material.BOOK) {
                    ...
                    if (itemMeta != null) {
                        ...
                        if (itemName.equals("Grimorio de Luz")) {
