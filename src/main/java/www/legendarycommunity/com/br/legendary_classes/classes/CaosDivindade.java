...
public class CaosDivindade implements Listener {

    private final Map<Integer, Integer> levels;
    private final Legendary_classes plugin;

    public CaosDivindade(Legendary_classes plugin) {
    ...
    public void applyPowers(Player player) {
        ...
        skillsUser.addStatModifier(new StatModifier("CaosDivindade_System_WISDOM", Stats.WISDOM, 100000.0));
        skillsUser.addStatModifier(new StatModifier("CaosDivindade_System_HEALTH", Stats.HEALTH, 100000.0));
        skillsUser.addStatModifier(new StatModifier("CaosDivindade_System_STRENGTH", Stats.STRENGTH, 100000.0));
        skillsUser.addStatModifier(new StatModifier("CaosDivindade_System_TOUGHNESS", Stats.TOUGHNESS, 100000.0));
        skillsUser.addStatModifier(new StatModifier("CaosDivindade_System_LUCK", Stats.LUCK, 20.0));
        skillsUser.addStatModifier(new StatModifier("CaosDivindade_System_SPEED", Stats.SPEED, 20.0));
    }
                    ...
                    if (livingEntity instanceof Player) {
                        ...
                        if (simpleClans != null) {
                            ...
                            if (AresClanPlayer != null && nearbyClanPlayer != null &&
                                ...
                                nearbyPlayer.addPotionEffect(new PotionEffect(PotionEffectType.SPEED, 60, 10));
                                nearbyPlayer.addPotionEffect(new PotionEffect(PotionEffectType.NIGHT_VISION, 60, 10));
                                nearbyPlayer.addPotionEffect(new PotionEffect(PotionEffectType.STRENGTH, 60, 10));
                                continue;
                            }
                        }
                    }
                    livingEntity.addPotionEffect(new PotionEffect(PotionEffectType.LEVITATION, 60, 1));
                }
            }
        }
    }
    ...
    public void onEntityKill(EntityDeathEvent event) {
        ...
        if (killer != null && IsCaosDivindade(killer)) {
    ...
    public boolean IsCaosDivindade(Player player) {
        PlayerClassData data = plugin.getPlayerData(player.getUniqueId());
        return data != null && "CaosDivindade".equalsIgnoreCase(data.getClassName());
    }
