...
public class AinzOoalGown implements Listener {
    ...
    public void applyPowers(Player player) {
        ...
        skillsUser.addStatModifier(new StatModifier("AinzOoalGown_System_WISDOM", Stats.WISDOM, 4096.0));
        skillsUser.addStatModifier(new StatModifier("AinzOoalGown_System_HEALTH", Stats.HEALTH, 4096.0));
        skillsUser.addStatModifier(new StatModifier("AinzOoalGown_System_STRENGTH", Stats.STRENGTH, 4096.0));
        skillsUser.addStatModifier(new StatModifier("AinzOoalGown_System_TOUGHNESS", Stats.TOUGHNESS, 4096.0));
